...
def create_study_confirmation_notification(confirmed_candidates, study_name, study_date):
    ...
    try:
        ...
        try:
            ...
            if failed_operations:
                ...
                # 중요한 작업(video_chat, notification)이 실패한 경우 롤백 고려
                critical_failures = [op for op in failed_operations if op[0] in ['video_chat', 'notification']]
